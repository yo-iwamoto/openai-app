  ...
  return (
    <div className='my-40 flex flex-col items-center gap-12 font-mono'>
      ...
      <ul className='flex flex-wrap items-center justify-center gap-8'>
        {urls.map((url) => (
          <a key={url} href={url} target='_blank' download='download.png' rel='noreferrer'>
            <img src={url} alt={text} className='h-64 w-64 rounded-md shadow-xl transition-transform hover:scale-105' />
          </a>
        ))}
      </ul>
    </div>
